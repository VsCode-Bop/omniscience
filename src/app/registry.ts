...
export const MODULES: ModuleDefinition[] = [
  ...
  // ─── Espace enseignant ───────────────────────────────────────────────────
  {
    ...
    status: 'prototype',
    icon: 'worksheet',
    summary: 'Fiches d\'exercices à valeurs aléatoires, du collège à la terminale, avec corrigés rédigés, versions A/B, impression PDF et export LaTeX ou Markdown.',
    tagline: `Exercices à valeurs aléatoires et corrigés, en LaTeX ou Markdown.`,
    features: [
      '30 modèles d\'exercices en mathématiques et physique-chimie, trois niveaux de difficulté',
      'Corrigés rédigés étape par étape, vérifiés automatiquement',
      'Versions A, B, C, D pour limiter la copie ; graine reproductible et lien de partage',
      'Aperçu A4, impression et PDF, export LaTeX (figures TikZ) et Markdown',
      'Barème, cartouche nom / prénom, exercices rédigés librement avec formules',
    ],
    libraries: ['KaTeX (aperçu et impression)', 'Générateurs et vérifications maison'],
    load: () => import('../modules/worksheet'),
  },
];
